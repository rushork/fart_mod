...
public class ModItems {
    ...
    public static final Item POO_INGOT = new Item(new Item.Settings().group(ItemGroup.MATERIALS));
    ...
    // Weapons
    public static final SwordItem POO_SWORD = new SwordItem(PooToolMaterial.INSTANCE, 0, 1f, new Item.Settings().group(ItemGroup.COMBAT));
    public static final ModSword FART_SWORD = new ModSword(PooToolMaterial.INSTANCE, 0, 1f, new Item.Settings().group(ItemGroup.COMBAT));
    ...
    public static void registerItems() {
        ...
        Registry.register(Registry.ITEM, new Identifier(Fartmod.MOD_ID, "fart_sword"), FART_SWORD);
